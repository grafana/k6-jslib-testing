...
function toHaveSomeValue(attribute, actualValue) {
  if (actualValue === null) {
    return fail({
...
function toHaveExactValue(attribute, actualValue, expectedValue) {
  if (actualValue === null) {
    return fail({
      type: "expected-received",
...
export async function toHaveAttribute(actual, attribute, expectedValue) {
