...
Deno.test("ConfigLoader.load", async (t) => {
    ...
    await t.step("colorize can be enforced by setting the K6_TESTING_COLORIZE environment variable to true", () => {
    ...
    await t.step("colorize can be enforced by setting the K6_TESTING_COLORIZE environment variable", () => {
    ...
    await t.step("colorize can be disabled by setting the K6_TESTING_COLORIZE environment variable to false", () => {
    ...
    await t.step("colorize is enabled if K6_TESTING_COLORIZE is set to any other value than false", () => {
    ...
    await t.step("display can be set to inline by setting the K6_TESTING_DISPLAY environment variable to inline", () => {
    ...
    await t.step("timeout can be set by setting the K6_TESTING_TIMEOUT environment variable", () => {
    ...
    await t.step("interval can be set by setting the K6_TESTING_INTERVAL environment variable", () => {
